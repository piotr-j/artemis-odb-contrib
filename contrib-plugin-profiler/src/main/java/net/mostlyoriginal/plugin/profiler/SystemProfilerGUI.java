...
<<<<<<< HEAD:contrib-plugin-profile/src/main/java/net/mostlyoriginal/api/SystemProfilerGUI.java
				if (current != skip)
=======
				if (current != skip && currentPoint > 0)
>>>>>>> upstream/master:contrib-plugin-profiler/src/main/java/net/mostlyoriginal/plugin/profiler/SystemProfilerGUI.java
